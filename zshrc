...
alias luamake=/home/alex/.config/lsp/lua-language-server/3rd/luamake/luamake
...
function bt_connect_headphones() {
    name="WH-1000XM4"

    headphones=$(bluetoothctl paired-devices | grep WH-1000XM4)

    echo "$headphones"
    mac_address=$(echo "$headphones" | awk '{print $2}')
